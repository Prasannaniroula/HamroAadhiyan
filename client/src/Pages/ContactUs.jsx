...
const Contact = () => {
    ...
    return (
    <>
            <section className="relative overflow-hidden bg-white py-20 px-10 dark:bg-dark lg:py-[120px]">
  ...
  return (
                ...
                const ContactInputBox = ({type, placeholder,onChange, name, value,defaultValue,readOnly}) => {
  return (
                <>
                    <div className="mb-4">
                        <input
...
const ContactControlInputBox = ({type, placeholder,onChange, name, value,defaultValue,readOnly}) => {
    return (
                  <>
                      <div className="mb-4">
                          <input
